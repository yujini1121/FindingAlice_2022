Shader "Ciconia Studio/CS_Polybrush/URP/Lite/Basic"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 break26_g1350 = uv_BaseMap;
				float L0GlobalTilingX150 = ( _GlobalXYTilingXYZWOffsetXY.x - 1.0 );
				float L0GlobalTilingY149 = ( _GlobalXYTilingXYZWOffsetXY.y - 1.0 );
				float2 appendResult14_g1350 = (float2(( break26_g1350.x * L0GlobalTilingX150 ) , ( break26_g1350.y * L0GlobalTilingY149 )));
				float L0GlobalOffsetX151 = _GlobalXYTilingXYZWOffsetXY.z;
				float L0GlobalOffsetY148 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g1350 = (float2(( break26_g1350.x + L0GlobalOffsetX151 ) , ( break26_g1350.y + L0GlobalOffsetY148 )));
				...
				float4 tex2DNode7_g1349 = tex2D( _BaseMap, ( ( appendResult14_g1350 + appendResult13_g1350 ) + Layer0Parallax215 ) );
				float clampResult27_g1349 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1349 = ( _BaseColor * tex2DNode7_g1349 ).rgb;
				float desaturateDot29_g1349 = dot( desaturateInitialColor29_g1349, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1349 = lerp( desaturateInitialColor29_g1349, desaturateDot29_g1349.xxx, -clampResult27_g1349 );
				float4 Layer0BaseColor179 = CalculateContrast(_Brightness,float4( desaturateVar29_g1349 , 0.0 ));
				float2 uv_BaseColorL1 = IN.ase_texcoord7.xyz.xy * _BaseColorL1_ST.xy + _BaseColorL1_ST.zw;
				float2 break26_g1348 = uv_BaseColorL1;
				float L1GlobalTilingX234 = ( _GlobalXYTilingXYZWOffsetXYL1.x - 1.0 );
				float L1GlobalTilingY235 = ( _GlobalXYTilingXYZWOffsetXYL1.y - 1.0 );
				float2 appendResult14_g1348 = (float2(( break26_g1348.x * L1GlobalTilingX234 ) , ( break26_g1348.y * L1GlobalTilingY235 )));
				float L1GlobalOffsetX236 = _GlobalXYTilingXYZWOffsetXYL1.z;
				float L1GlobalOffsetY237 = _GlobalXYTilingXYZWOffsetXYL1.w;
				float2 appendResult13_g1348 = (float2(( break26_g1348.x + L1GlobalOffsetX236 ) , ( break26_g1348.y + L1GlobalOffsetY237 )));
				...
				float4 tex2DNode7_g1347 = tex2D( _BaseColorL1, ( ( appendResult14_g1348 + appendResult13_g1348 ) + Layer1Parallax247 ) );
				float clampResult27_g1347 = clamp( _SaturationL1 , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1347 = ( _ColorL1 * tex2DNode7_g1347 ).rgb;
				float desaturateDot29_g1347 = dot( desaturateInitialColor29_g1347, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1347 = lerp( desaturateInitialColor29_g1347, desaturateDot29_g1347.xxx, -clampResult27_g1347 );
				float4 Layer1BaseColor261 = CalculateContrast(_BrightnessL1,float4( desaturateVar29_g1347 , 0.0 ));
				float4 break106 = IN.ase_color;
				float VertexG115 = break106.g;
				float temp_output_21_0_g1351 = VertexG115;
				float Layer0Heightmap336 = tex2DNode3_g1056.b;
				float temp_output_49_0_g1351 = ( _L1BlendContrast - 1.5 );
				float clampResult11_g1351 = clamp( ( ( _L1BlendAmount - 2.37 ) + (( 1.0 + temp_output_49_0_g1351 ) + (Layer0Heightmap336 - 0.0) * (-temp_output_49_0_g1351 - ( 1.0 + temp_output_49_0_g1351 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1351 = clampResult11_g1351;
				float blendOpDest18_g1351 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1351 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1351 = (( _L1ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1351 * blendOpDest18_g1351 ) )) ):( clampResult11_g1351 ));
				float blendOpDest31_g1351 = temp_output_21_0_g1351;
				float VertexGHeightmap352 = ( (( _L1UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1351 + blendOpDest31_g1351 ) )) ):( temp_output_21_0_g1351 )) * _L1BlendOpacity );
				...
				float temp_output_21_0_g1352 = VertexA117;
				float temp_output_55_0_g1352 = ( _L2BlendAmount - 2.37 );
				float lerpResult47_g1352 = lerp( temp_output_55_0_g1352 , ( temp_output_55_0_g1352 - temp_output_55_0_g1352 ) , VertexG115);
				...
				float temp_output_56_0_g1352 = ( _L2BlendContrast - 1.5 );
				float clampResult11_g1352 = clamp( ( lerpResult47_g1352 + (( 1.0 + temp_output_56_0_g1352 ) + (lerpResult830 - 0.0) * (-temp_output_56_0_g1352 - ( 1.0 + temp_output_56_0_g1352 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1352 = clampResult11_g1352;
				float blendOpDest18_g1352 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1352 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1352 = (( _L2ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1352 * blendOpDest18_g1352 ) )) ):( clampResult11_g1352 ));
				float blendOpDest31_g1352 = temp_output_21_0_g1352;
				float VertexBHeightmap652 = ( (( _L2UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1352 + blendOpDest31_g1352 ) )) ):( temp_output_21_0_g1352 )) * _L2BlendOpacity );
				...
				float2 break26_g1362 = uv_BumpMap;
				float2 appendResult14_g1362 = (float2(( break26_g1362.x * L0GlobalTilingX150 ) , ( break26_g1362.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1362 = (float2(( break26_g1362.x + L0GlobalOffsetX151 ) , ( break26_g1362.y + L0GlobalOffsetY148 )));
				float3 unpack4_g1361 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1362 + appendResult13_g1362 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1361.z = lerp( 1, unpack4_g1361.z, saturate(_BumpScale) );
				float3 Layer0Normal193 = unpack4_g1361;
				float2 uv_BumpMapL1 = IN.ase_texcoord7.xyz.xy * _BumpMapL1_ST.xy + _BumpMapL1_ST.zw;
				float2 break26_g1365 = uv_BumpMapL1;
				float2 appendResult14_g1365 = (float2(( break26_g1365.x * L1GlobalTilingX234 ) , ( break26_g1365.y * L1GlobalTilingY235 )));
				float2 appendResult13_g1365 = (float2(( break26_g1365.x + L1GlobalOffsetX236 ) , ( break26_g1365.y + L1GlobalOffsetY237 )));
				float3 unpack4_g1364 = UnpackNormalScale( tex2D( _BumpMapL1, ( ( appendResult14_g1365 + appendResult13_g1365 ) + Layer1Parallax247 ) ), _BumpScaleL1 );
				unpack4_g1364.z = lerp( 1, unpack4_g1364.z, saturate(_BumpScaleL1) );
				float3 tex2DNode4_g1364 = unpack4_g1364;
				float3 Layer1Normal260 = tex2DNode4_g1364;
