Shader "Ciconia Studio/CS_Polybrush/URP/Lite/Snow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float4 TriplanarSampling274_g1551( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 temp_output_8_0_g1549 = CalculateContrast(_L0Heightmapcontrast,( temp_cast_1 + (-0.5 + (_L0HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer0VertexOffset1124 = ( float4( ( v.ase_normal * ( _L0Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1549 );
				...
				float4 tex2DNode3_g1503 = tex2Dlod( _MetallicGlossMapMAHSL2, float4( ( ( appendResult14_g1504 + appendResult13_g1504 ) + float2( 0,0 ) ), 0, 0.0) );
				float Layer2Heightmap1053 = tex2DNode3_g1503.b;
				float4 temp_cast_4 = (Layer2Heightmap1053).xxxx;
				float4 temp_output_8_0_g1550 = CalculateContrast(_L2Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L2HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer2VertexOffset1144 = ( float4( ( v.ase_normal * ( _L2Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1550 );
				...
				#endif
				float3 vertexValue = VertexOffset1133.rgb;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 break26_g1545 = uv_BaseMap;
				float L0GlobalTilingX150 = ( _GlobalXYTilingXYZWOffsetXY.x - 1.0 );
				float L0GlobalTilingY149 = ( _GlobalXYTilingXYZWOffsetXY.y - 1.0 );
				float2 appendResult14_g1545 = (float2(( break26_g1545.x * L0GlobalTilingX150 ) , ( break26_g1545.y * L0GlobalTilingY149 )));
				float L0GlobalOffsetX151 = _GlobalXYTilingXYZWOffsetXY.z;
				float L0GlobalOffsetY148 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g1545 = (float2(( break26_g1545.x + L0GlobalOffsetX151 ) , ( break26_g1545.y + L0GlobalOffsetY148 )));
				...
				float4 tex2DNode7_g1544 = tex2D( _BaseMap, ( ( appendResult14_g1545 + appendResult13_g1545 ) + Layer0Parallax215 ) );
				float4 lerpResult53_g1544 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g1544 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g1544 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1544 = lerpResult53_g1544.rgb;
				float desaturateDot29_g1544 = dot( desaturateInitialColor29_g1544, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1544 = lerp( desaturateInitialColor29_g1544, desaturateDot29_g1544.xxx, -clampResult27_g1544 );
				float4 Layer0BaseColor179 = CalculateContrast(_Brightness,float4( desaturateVar29_g1544 , 0.0 ));
				float2 uv_BaseColorL2 = IN.ase_texcoord7.xy * _BaseColorL2_ST.xy + _BaseColorL2_ST.zw;
				float2 break26_g1547 = uv_BaseColorL2;
				float L2GlobalTilingX484 = ( _GlobalXYTilingXYZWOffsetXYSnow.x - 1.0 );
				float L2GlobalTilingY486 = ( _GlobalXYTilingXYZWOffsetXYSnow.y - 1.0 );
				float2 appendResult14_g1547 = (float2(( break26_g1547.x * L2GlobalTilingX484 ) , ( break26_g1547.y * L2GlobalTilingY486 )));
				float L2GlobalOffsetX483 = _GlobalXYTilingXYZWOffsetXYSnow.z;
				float L2GlobalOffsetY485 = _GlobalXYTilingXYZWOffsetXYSnow.w;
				float2 appendResult13_g1547 = (float2(( break26_g1547.x + L2GlobalOffsetX483 ) , ( break26_g1547.y + L2GlobalOffsetY485 )));
				...
				float4 tex2DNode7_g1546 = tex2D( _BaseColorL2, ( ( appendResult14_g1547 + appendResult13_g1547 ) + Layer2Parallax1055 ) );
				float clampResult27_g1546 = clamp( _SaturationL2 , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1546 = ( _ColorL2 * tex2DNode7_g1546 ).rgb;
				float desaturateDot29_g1546 = dot( desaturateInitialColor29_g1546, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1546 = lerp( desaturateInitialColor29_g1546, desaturateDot29_g1546.xxx, -clampResult27_g1546 );
				float4 Layer2BaseColor1070 = CalculateContrast(_BrightnessL2,float4( desaturateVar29_g1546 , 0.0 ));
				float4 break106 = IN.ase_color;
				float VertexB116 = break106.b;
				float temp_output_21_0_g1548 = VertexB116;
				float Layer0Heightmap336 = tex2DNode3_g1501.b;
				float clampResult11_g1548 = clamp( ( (-4.0 + (_L2BlendAmount - 0.0) * (1.0 - -4.0) / (1.0 - 0.0)) + (( 1.0 + _L2BlendContrast ) + (Layer0Heightmap336 - 0.0) * (-_L2BlendContrast - ( 1.0 + _L2BlendContrast )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1548 = clampResult11_g1548;
				float blendOpDest18_g1548 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1548 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1548 = (( _L2ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1548 * blendOpDest18_g1548 ) )) ):( clampResult11_g1548 ));
				float blendOpDest31_g1548 = temp_output_21_0_g1548;
				float VertexBHeightmap1077 = ( (( _L2UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1548 + blendOpDest31_g1548 ) )) ):( temp_output_21_0_g1548 )) * _L2BlendOpacity );
				...
				float4 temp_output_8_0_g1549 = CalculateContrast(_L0Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L0HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer0VisHeightmap1125 = temp_output_8_0_g1549;
				float VertexR114 = break106.r;
				float Layer2Heightmap1053 = tex2DNode3_g1503.b;
				float4 temp_cast_6 = (Layer2Heightmap1053).xxxx;
				float4 temp_output_8_0_g1550 = CalculateContrast(_L2Heightmapcontrast,( temp_cast_6 + (-0.5 + (_L2HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer2VisHeightmap1145 = temp_output_8_0_g1550;
				float VertexG115 = break106.g;
				float2 texCoord106_g1551 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult149_g1551 = clamp( _TilingInstance , 0.0 , 1000.0 );
				float2 temp_output_175_0_g1551 = Layer2Parallax1055;
				float temp_output_123_0_g1551 = ( tex2D( _SparkleMask, ( ( ( texCoord106_g1551 * _TilingDotMask ) * clampResult149_g1551 ) + temp_output_175_0_g1551 ) ).a + (-1.2 + (_SpreadDotMask - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) );
				float saferPower230_g1551 = abs( temp_output_123_0_g1551 );
				float temp_output_121_0_g1551 = ( _ContrastDotMask + 1.0 );
				float clampResult118_g1551 = clamp( pow( saferPower230_g1551 , temp_output_121_0_g1551 ) , 0.0 , 1.0 );
				float clampResult240_g1551 = clamp( _SparklePower , 0.0 , 100000.0 );
				float temp_output_277_0_g1551 = ( ( clampResult118_g1551 * _IntensityDotMask ) * clampResult240_g1551 );
				float VisualizeDotMap1001 = temp_output_277_0_g1551;
				float4 temp_cast_8 = (VisualizeDotMap1001).xxxx;
				float temp_output_135_0_g1551 = ( _ContrastSparkles - -1.0 );
				float2 temp_cast_9 = (( ( _TilingCrystals / 10.0 ) * clampResult149_g1551 )).xx;
				float3 worldToObj273_g1551 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 triplanar274_g1551 = TriplanarSampling274_g1551( _SparkleMask, ( ( ( worldToObj273_g1551 / 4.0 ) - WorldViewDirection ) + float3( temp_output_175_0_g1551 ,  0.0 ) ), WorldNormal, 1.0, temp_cast_9, 1.0, 0 );
				float clampResult49_g1551 = clamp( _Desaturatecrystals , 0.0 , 1.0 );
				float3 desaturateInitialColor53_g1551 = triplanar274_g1551.xyz;
				float desaturateDot53_g1551 = dot( desaturateInitialColor53_g1551, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar53_g1551 = lerp( desaturateInitialColor53_g1551, desaturateDot53_g1551.xxx, clampResult49_g1551 );
				float lerpResult246_g1551 = lerp( 0.6 , 1.0 , _AmountSparkle);
				float4 clampResult74_g1551 = clamp( ( saturate( ( CalculateContrast(temp_output_135_0_g1551,float4( desaturateVar53_g1551 , 0.0 )) + (( -1.0 - temp_output_135_0_g1551 ) + (lerpResult246_g1551 - 0.0) * (0.0 - ( -1.0 - temp_output_135_0_g1551 )) / (1.0 - 0.0)) ) ) * _CrystalsIntensity ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 VisualizeSparklesMap1002 = clampResult74_g1551;
				...
				float4 staticSwitch1013 = temp_cast_8;
				...
				float2 break26_g1557 = uv_BumpMap;
				float2 appendResult14_g1557 = (float2(( break26_g1557.x * L0GlobalTilingX150 ) , ( break26_g1557.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1557 = (float2(( break26_g1557.x + L0GlobalOffsetX151 ) , ( break26_g1557.y + L0GlobalOffsetY148 )));
				float3 unpack4_g1556 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1557 + appendResult13_g1557 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1556.z = lerp( 1, unpack4_g1556.z, saturate(_BumpScale) );
				float3 tex2DNode4_g1556 = unpack4_g1556;
				float3 Layer0Normal193 = tex2DNode4_g1556;
				float2 uv_BumpMapL2 = IN.ase_texcoord7.xy * _BumpMapL2_ST.xy + _BumpMapL2_ST.zw;
				float2 break26_g1559 = uv_BumpMapL2;
				float2 appendResult14_g1559 = (float2(( break26_g1559.x * L2GlobalTilingX484 ) , ( break26_g1559.y * L2GlobalTilingY486 )));
				float2 appendResult13_g1559 = (float2(( break26_g1559.x + L2GlobalOffsetX483 ) , ( break26_g1559.y + L2GlobalOffsetY485 )));
				float3 unpack4_g1558 = UnpackNormalScale( tex2D( _BumpMapL2, ( ( appendResult14_g1559 + appendResult13_g1559 ) + Layer2Parallax1055 ) ), _BumpScaleL2 );
				unpack4_g1558.z = lerp( 1, unpack4_g1558.z, saturate(_BumpScaleL2) );
				float3 tex2DNode4_g1558 = unpack4_g1558;
				float3 Layer2Normal1062 = tex2DNode4_g1558;
				...
				float2 break26_g1553 = uv_EmissionMap;
				float2 appendResult14_g1553 = (float2(( break26_g1553.x * L0GlobalTilingX150 ) , ( break26_g1553.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1553 = (float2(( break26_g1553.x + L0GlobalOffsetX151 ) , ( break26_g1553.y + L0GlobalOffsetY148 )));
				float4 temp_output_5_0_g1552 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g1553 + appendResult13_g1553 ) + Layer0Parallax215 ) ) );
				float4 Layer0Emission984 = ( temp_output_5_0_g1552 * _EmissionIntensity );
				float4 temp_cast_14 = (0.0).xxxx;
				float4 lerpResult1118 = lerp( Layer0Emission984 , temp_cast_14 , VertexBHeightmap1077);
				float4 temp_output_108_0_g1551 = ( clampResult74_g1551 * temp_output_277_0_g1551 );
				...
				float4 temp_cast_15 = (Layer2Ao1071).xxxx;
				float dotResult152_g1551 = dot( WorldNormal , SafeNormalize(_MainLightPosition.xyz) );
				float temp_output_153_0_g1551 = max( dotResult152_g1551 , 0.0 );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float lerpResult169_g1551 = lerp( ( temp_output_153_0_g1551 * _MainLightColor.a ) , ( temp_output_153_0_g1551 * ( ase_lightAtten * _MainLightColor.a ) ) , _ShadowMask);
				float4 temp_output_165_0_g1551 = ( (( _AoMask )?( ( temp_output_108_0_g1551 * temp_cast_15 ) ):( temp_output_108_0_g1551 )) * lerpResult169_g1551 );
				float4 temp_output_1160_0 = temp_output_165_0_g1551;
				...
				float4 Layer0EmissionRGB1086 = temp_output_5_0_g1552;
				...
				float4 temp_cast_18 = (Layer0Smoothness210).xxxx;
				...
				#elif defined(_SPARKLESOURCE3_EMISSIVESPARKLES)
				float4 staticSwitch1035 = temp_cast_19;
				#else
				float4 staticSwitch1035 = temp_cast_19;
				#endif
				float4 Layer2Smoothness1073 = staticSwitch1035;
				float4 lerpResult301 = lerp( temp_cast_18 , Layer2Smoothness1073 , VertexBHeightmap1077);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float4 Layer2VisHeightmap1145 = temp_output_8_0_g1550;
				float VertexG115 = break106.g;
				float2 texCoord106_g1551 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult149_g1551 = clamp( _TilingInstance , 0.0 , 1000.0 );
				float2 temp_output_175_0_g1551 = Layer2Parallax1055;
				float temp_output_123_0_g1551 = ( tex2D( _SparkleMask, ( ( ( texCoord106_g1551 * _TilingDotMask ) * clampResult149_g1551 ) + temp_output_175_0_g1551 ) ).a + (-1.2 + (_SpreadDotMask - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) );
				float saferPower230_g1551 = abs( temp_output_123_0_g1551 );
				...
				float2 temp_cast_9 = (( ( _TilingCrystals / 10.0 ) * clampResult149_g1551 )).xx;
				float3 worldToObj273_g1551 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 triplanar274_g1551 = TriplanarSampling274_g1551( _SparkleMask, ( ( ( worldToObj273_g1551 / 4.0 ) - ase_worldViewDir ) + float3( temp_output_175_0_g1551 ,  0.0 ) ), ase_worldNormal, 1.0, temp_cast_9, 1.0, 0 );
				float clampResult49_g1551 = clamp( _Desaturatecrystals , 0.0 , 1.0 );
				float3 desaturateInitialColor53_g1551 = triplanar274_g1551.xyz;
				float desaturateDot53_g1551 = dot( desaturateInitialColor53_g1551, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar53_g1551 = lerp( desaturateInitialColor53_g1551, desaturateDot53_g1551.xxx, clampResult49_g1551 );
				...
				float Layer2Ao1071 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g1503 ) * ( 1.0 - blendOpDest34_g1503 ) ) ));
				float4 temp_cast_15 = (Layer2Ao1071).xxxx;
				float dotResult152_g1551 = dot( ase_worldNormal , SafeNormalize(_MainLightPosition.xyz) );
				float temp_output_153_0_g1551 = max( dotResult152_g1551 , 0.0 );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
