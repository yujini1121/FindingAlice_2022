Shader "Ciconia Studio/CS_Polybrush/URP/Basic/Standard"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _GlossinessL1;
			float _Metallic;
			float _L2EmissionIntensity1;
			float _EmissionIntensity;
			float _UseEmissionFromMainPropertiesOld;
			float _BumpScaleL1;
			float _MetallicL1;
			float _Brightness;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 break26_g1410 = uv_BaseMap;
				...
				float2 paralaxOffset38_g1060 = ParallaxOffset( tex2DNode3_g1060.b , _Parallax , ase_tanViewDir );
				float2 switchResult37_g1060 = (((ase_vface>0)?(paralaxOffset38_g1060):(0.0)));
				float2 Layer0Parallax215 = switchResult37_g1060;
				float4 tex2DNode7_g1409 = tex2D( _BaseMap, ( ( appendResult14_g1410 + appendResult13_g1410 ) + Layer0Parallax215 ) );
				float clampResult27_g1409 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1409 = ( _BaseColor * tex2DNode7_g1409 ).rgb;
				...
				float2 break26_g1063 = uv_MetallicGlossMapMAHSL1;
				float2 appendResult14_g1063 = (float2(( break26_g1063.x * L1GlobalTilingX234 ) , ( break26_g1063.y * L1GlobalTilingY235 )));
				float2 appendResult13_g1063 = (float2(( break26_g1063.x + L1GlobalOffsetX236 ) , ( break26_g1063.y + L1GlobalOffsetY237 )));
				float4 tex2DNode3_g1062 = tex2D( _MetallicGlossMapMAHSL1, ( ( appendResult14_g1063 + appendResult13_g1063 ) + float2( 0,0 ) ) );
				float2 paralaxOffset38_g1062 = ParallaxOffset( tex2DNode3_g1062.b , _ParallaxL1 , ase_tanViewDir );
				float2 switchResult37_g1062 = (((ase_vface>0)?(paralaxOffset38_g1062):(0.0)));
				float2 Layer1Parallax247 = switchResult37_g1062;
				...
				float temp_output_49_0_g1389 = ( _L1BlendContrast - 1.5 );
				float clampResult11_g1389 = clamp( ( ( _L1BlendAmount - 2.37 ) + (( 1.0 + temp_output_49_0_g1389 ) + (Layer0Heightmap336 - 0.0) * (-temp_output_49_0_g1389 - ( 1.0 + temp_output_49_0_g1389 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				...
				float2 break26_g1416 = uv_BumpMap;
				float2 appendResult14_g1416 = (float2(( break26_g1416.x * L0GlobalTilingX150 ) , ( break26_g1416.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1416 = (float2(( break26_g1416.x + L0GlobalOffsetX151 ) , ( break26_g1416.y + L0GlobalOffsetY148 )));
				float3 unpack4_g1415 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1416 + appendResult13_g1416 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1415.z = lerp( 1, unpack4_g1415.z, saturate(_BumpScale) );
				float3 tex2DNode4_g1415 = unpack4_g1415;
				float3 Layer0Normal193 = tex2DNode4_g1415;
				float2 uv_BumpMapL1 = IN.ase_texcoord7.xy * _BumpMapL1_ST.xy + _BumpMapL1_ST.zw;
				float2 break26_g1414 = uv_BumpMapL1;
				float2 appendResult14_g1414 = (float2(( break26_g1414.x * L1GlobalTilingX234 ) , ( break26_g1414.y * L1GlobalTilingY235 )));
				float2 appendResult13_g1414 = (float2(( break26_g1414.x + L1GlobalOffsetX236 ) , ( break26_g1414.y + L1GlobalOffsetY237 )));
				float3 unpack4_g1413 = UnpackNormalScale( tex2D( _BumpMapL1, ( ( appendResult14_g1414 + appendResult13_g1414 ) + Layer1Parallax247 ) ), _BumpScaleL1 );
				unpack4_g1413.z = lerp( 1, unpack4_g1413.z, saturate(_BumpScaleL1) );
				float3 tex2DNode4_g1413 = unpack4_g1413;
				float3 Layer1Normal260 = tex2DNode4_g1413;
				...
				float2 break26_g1412 = uv_EmissionMap;
				float2 appendResult14_g1412 = (float2(( break26_g1412.x * L0GlobalTilingX150 ) , ( break26_g1412.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1412 = (float2(( break26_g1412.x + L0GlobalOffsetX151 ) , ( break26_g1412.y + L0GlobalOffsetY148 )));
				float4 temp_output_5_0_g1411 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g1412 + appendResult13_g1412 ) + Layer1Parallax247 ) ) );
				float4 Layer0Emission984 = ( temp_output_5_0_g1411 * _EmissionIntensity );
				float4 temp_cast_5 = (0.0).xxxx;
				float4 lerpResult1019 = lerp( Layer0Emission984 , temp_cast_5 , VertexGHeightmap352);
				float4 Layer0EmissionRGB1023 = temp_output_5_0_g1411;
				...
				float Layer1Metallic263 = ( tex2DNode3_g1062.r * _MetallicL1 );
				...
				float temp_output_1_0_g1062 = ( tex2DNode3_g1062.a * _GlossinessL1 );
				float Layer1Smoothness264 = temp_output_1_0_g1062;
				...
				float blendOpDest34_g1062 = ( 1.0 - _AoIntensityL1 );
				float Layer1Ao262 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g1062 ) * ( 1.0 - blendOpDest34_g1062 ) ) ));
